...
impl I2CDisplayInterface {
    ...
    pub fn new_async<I>(i2c: I) -> I2CInterface<I>
    where
        I: embedded_hal_async::i2c::I2c,
    {
        Self::new_custom_address_async(i2c, 0x3C)
    }
    ...
    pub fn new_alternate_address_async<I>(i2c: I) -> I2CInterface<I>
    where
        I: embedded_hal_async::i2c::I2c,
    {
        Self::new_custom_address_async(i2c, 0x3D)
    }
    ...
    pub fn new_custom_address_async<I>(i2c: I, address: u8) -> I2CInterface<I>
    where
        I: embedded_hal_async::i2c::I2c,
    {
        I2CInterface::new(i2c, address, 0x40)
